function validate()
{
    ...
    chechpasswordsmatch(password , cpassword)
}
...
function checkemail(email)
{
    if(email.length>8 && email.includes('@gmail'))
    {
        ...
        document.getElementById('email_error').innerText='email length include @gmail and 8 letters long'
    }
}
...
function chechpasswordsmatch(password , cpassword)
{
